...
@export var default_click_sfx: AudioStream = preload("res://assets/audio/ui/player_answered.wav")

## Default sound effect to play when a UI button is hovered or focused.
@export var default_hover_sfx: AudioStream = preload("res://assets/audio/ui/standart_ui_hover.wav")
