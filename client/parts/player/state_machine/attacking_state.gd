...
const SWORD_ATTACK_1: AudioStream = preload("res://assets/audio/player/Sword Attack 1.wav")
## Sound effect played during the second attack in the combo.
const SWORD_ATTACK_2: AudioStream = preload("res://assets/audio/player/Sword Attack 2.wav")
