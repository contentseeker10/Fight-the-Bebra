...
const FOOTSTEPS: Array[AudioStream] = [
	preload("res://assets/audio/player/Dirt Run 1.wav"),
	preload("res://assets/audio/player/Dirt Run 2.wav"),
	preload("res://assets/audio/player/Dirt Run 3.wav"),
	preload("res://assets/audio/player/Dirt Run 4.wav"),
	preload("res://assets/audio/player/Dirt Run 5.wav")
]
